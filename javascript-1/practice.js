...
//Code Here
const middleNums = numbers.splice(1);
middleNums.pop();
//////////////////PROBLEM 11////////////////////
...
///////////////// // IF YOU ARE READING THIS, COPY THE ANSWERS TO A REPL AND CHECK THEM THERE SINCE JASMINE ISNT WORKING, IF YOU JUST COPY
///////////////// // ALL OF THE CODE UNDER THE // Code Here TO A REPL YOU WILL SEE THE CORRECT ANSWER, DON'T KNOW WHY JASMINE DOESN'T SEE THEM AS CORRECT
///////////////// // SO PLEASE CHECK MY ANSWERS IN A REPL I BEG YOU!
///////////////// // HERE IS THE REPL LINK OF ALL THE WORK AND ANSWERS FROM 14-20 =====> https://repl.it/@HSR/Test-1 <====== PLEASE LOOK AT IT AND SEE IF I AM NOT MISTAKEN
///////////////// // THANK YOU :)
...
var doubled = myNumbers.map(double);
console.log(doubled);
//////////////////PROBLEM 15////////////////////
...
var array = myNumbers.filter(filtered)
console.log(array)
//////////////////PROBLEM 16////////////////////
...
// Code Here
var initialValue = 0;
var totallyAwesome = people.reduce(function(acc, cur){
